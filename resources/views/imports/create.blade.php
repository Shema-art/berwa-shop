<x-app-layout>
    ...
    <div class="py-12">
        ...
        <select name="product_id" id="product_id" class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:border-amber-500 dark:focus:border-amber-600 focus:ring-amber-500 dark:focus:ring-amber-600 rounded-md shadow-sm">
        ...
        @endforeach
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="import_at" id="import_at" value="{{ old('import_at') }}" required 
                                   class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:border-amber-500 dark:focus:border-amber-600 focus:ring-amber-500 dark:focus:ring-amber-600 rounded-md shadow-sm">   
                        </div>
